...
baseFileName = ('F:\BTP\sample_img\CorelDB\obj_dish\433044.jpg')%'coins.png';
...
axis image;
title('Only the nickels from the originalkrjtjeriyu5e image', 'FontSize', captionFontSize);
%
%
%
%To be done
 
colorImg = baseFileName;

 colorImg(~nickelBinaryImage) = 0;
